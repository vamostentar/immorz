            ...
            <div className="flex items-center gap-6">
                ...
                <div className="flex-shrink-0">
                    {agent.avatar ? (
                        ...
                        <div className="w-32 h-32 rounded-full border-4 border-white shadow-xl bg-blue-400 flex items-center justify-center text-4xl font-bold">
                        ...
                        <div className="flex items-center gap-2 mb-4">
                            <div className="flex gap-1">
                                {[1, 2, 3, 4, 5].map((star) => (
                                    <svg
                                        key={star}
                                        className={`w-6 h-6 ${star <= (agent.rating || 0) ? 'text-yellow-400' : 'text-gray-300'
                                            }`}
                                        fill="currentColor"
                                        viewBox="0 0 20 20"
                                    >
                            ...
                            <span className="text-blue-100">
                                {agent.rating.toFixed(1)} ({agent.reviewCount || 0} {agent.reviewCount === 1 ? 'avaliação' : 'avaliações'})
                            </span>
                        </div>
                    )}
